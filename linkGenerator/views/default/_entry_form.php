<?php
/* @var $minus bool */
/* @var $entry \app\modules\linkGenerator\models\LinksArticlesRelations */
...
<tr>
    ...
    <td>
        <?= Html::textarea($entry->formName() . '[' . $id .'][intro]', $entry->intro, [
            'class' => 'form-control intro-text',
            'required' => true,
        ]) ?>
